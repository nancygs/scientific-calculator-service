 ...
 * 
 */
package com.negs.springboot.microservice.scientific.calculator.exception;
...
@ControllerAdvice
@Slf4j
public class ScientificCalculatorExceptionHandler extends ResponseEntityExceptionHandler {
