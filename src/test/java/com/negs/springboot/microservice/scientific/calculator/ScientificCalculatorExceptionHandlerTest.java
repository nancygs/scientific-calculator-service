...
public class ScientificCalculatorExceptionHandlerTest {
	...
	public void whenTry_thenOK() {
		...
		ResponseEntity<String> response = restTemplate.exchange("/scientific-calculator/square/5", HttpMethod.GET, entity,
				String.class);
	...
	public void handleMethodArgumentTypeMismatchTest() throws JSONException {
		...
		ResponseEntity<String> response = restTemplate.exchange("/scientific-calculator/square/5a", HttpMethod.GET, entity,
				String.class);
